...
const ctfModules = ['artifact', 'binary', 'capabilities', 'crypto', 'crypto-exec', 'environment', 'human', 'mcp', 'misc', 'one-gadget', 'pwninit', 'python', 'retools', 'router', 'seccomp', 'setup', 'types', 'web']
