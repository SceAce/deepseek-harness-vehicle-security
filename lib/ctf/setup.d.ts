...
export type CtfSetupTarget = 'gdb_pwndbg' | 'ida_pro' | 'r2' | 'one_gadget' | 'seccomp_tools' | 'sage' | 'pari_gp' | 'windows_re' | 'android_re' | 'arm_re' | 'chrome_mcp' | 'chrome_devtools_mcp' | 'mitmproxy' | 'python_ctf_env' | 'blackarch_repo';
