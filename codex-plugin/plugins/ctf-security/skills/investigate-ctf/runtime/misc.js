...
export async function triageMiscArtifact(file, options = {}) {
...
export async function profilePcapArtifact(file, options = {}) {
    const profile = await profileCtfArtifact(file, options);
    const base = emptyResult();
    base.commands.push(...profile.commands);
    base.artifacts.push(profile.artifact);
...
async function optionalProbe(executableName, argv, outputKey, outputs, base, options) {
