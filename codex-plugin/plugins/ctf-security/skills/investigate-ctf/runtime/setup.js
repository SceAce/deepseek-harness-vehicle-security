...
function buildSetupRequest(target, context) {
    switch (target) {
        ...
        case 'seccomp_tools':
            return requestFromOperations('start_service', 'Install or refresh seccomp-tools', 'Pwn analysis needs a direct seccomp filter dump and syscall allow/deny view.', [
                {
                    order: 1,
                    kind: 'command',
        ...
        case 'one_gadget':
            return requestFromOperations('start_service', 'Install or refresh one_gadget', 'Pwn analysis needs libc one_gadget candidates after the challenge runtime and libc have been identified.', [
                {
                    order: 1,
                    kind: 'command',
